...
Public Class rpt_TIQuotation
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "InsMgt.rpt_TIQuotation.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_TIQuotation
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_TIQuotation = New rpt_TIQuotation()
        rpt.Site = Me.Site
        Return rpt
    End Function
