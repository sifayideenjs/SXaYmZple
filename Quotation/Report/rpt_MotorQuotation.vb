...
Public Class rpt_MotorQuotation
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "InsMgt.rpt_MotorQuotation.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_MotorQuotation
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_MotorQuotation = New rpt_MotorQuotation()
        rpt.Site = Me.Site
        Return rpt
    End Function
